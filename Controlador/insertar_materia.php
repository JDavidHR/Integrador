...
if(isset($_POST['submit']) && !empty($_POST['nombre_materia'])){
        ...
        $sql=$mysql->efectuarConsulta("insert into integrador.materias(nombre) VALUES ('".$materia."')");
        ...
        if($sql){
            ...
            echo"<script type=\"text/javascript\">alert('Se produjo un error'); window.location='../registro_materia.php';</script>";
        }
